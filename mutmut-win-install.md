...
```bash
uv add "mutmut-win @ git+https://github.com/pgm1980/mutmut-win.git@v1.0.0" --dev
```
...
```
Erwartete Ausgabe: `mutmut-win, version 1.0.0`
...
Folgende Einträge in der CLAUDE.md des Projekts ergänzen:
