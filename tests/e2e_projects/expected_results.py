...
EXPECTED_MY_LIB: dict[str, dict[str, int]] = {
    "mutants/src/my_lib/__init__.py.meta": {
        ...
        "my_lib.x_make_greeter__mutmut_8": 0,
        "my_lib.x_make_greeter__mutmut_9": 0,
        ...
        "my_lib.x_simple_consumer__mutmut_8": 0,
        "my_lib.x_simple_consumer__mutmut_9": 0,
        "my_lib.x_simple_consumer__mutmut_10": 0,
        ...
        "my_lib.xǁPointǁabs__mutmut_7": 0,
        "my_lib.xǁPointǁabs__mutmut_8": 0,
        "my_lib.xǁPointǁabs__mutmut_9": 0,
        ...
        "my_lib.x_create_a_segfault_when_mutated__mutmut_4": 0,
        ...
        "my_lib.x_func_with_star__mutmut_4": 0,
        "my_lib.x_func_with_arbitrary_args__mutmut_1": 1,
        "my_lib.x_func_with_arbitrary_args__mutmut_2": 0,
    },
}
...
EXPECTED_TYPE_CHECKING: dict[str, dict[str, int]] = {
    "mutants/src/type_checking/__init__.py.meta": {
        ...
        "type_checking.x_hello__mutmut_5": 0,
        "type_checking.x_a_hello_wrapper__mutmut_1": 37,
        "type_checking.x_a_hello_wrapper__mutmut_2": 0,
        "type_checking.x_a_hello_wrapper__mutmut_3": 0,
        "type_checking.xǁPersonǁget_name__mutmut_1": 0,
        ...
        "type_checking.x_mutate_me__mutmut_6": 0,
        "type_checking.x_mutate_me__mutmut_7": 0,
    },
}
