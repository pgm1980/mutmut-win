...
|------|--------|-----------|----------|
| Tests | `uv run pytest --ignore=tests/e2e_projects` | 719 + neue ≥ 745 passed | ✅ **773 passed / 4 skipped** (+54 neue Tests) |
| Linting | `uv run ruff check src/ tests/` | 0 Findings | ✅ All checks passed |
| Type Check | `uv run mypy src/mutmut_win/` | keine NEUEN Errors (26 pre-existing) | ✅ **20 pre-existing, 0 neue** (Baseline 26→20: code_coverage-Neufassung u. a. tilgten 6) |
| Security | `semgrep scan --config auto src/mutmut_win/` | 0 Findings | ✅ 0 Findings (290 Regeln, 30 Dateien; der eine Zwischenfund — f-String-DELETE aus #96 — strukturell via executemany beseitigt statt unterdrückt, `09c6cd7`) |
| Architecture | lint-imports (läuft in der Suite) | KEPT | ✅ in der Suite grün |
| Mutation Testing | — | deferred bis C8 (Sprint 32) | ⏸ deferred |

**Item-Commits:** #91 `33c2c98` · #92 `108ed87` · #93 `18011c9` · #94
`80f38ab` · #95 `75983f2` (Entscheid: JA, reaktiviert) · #96 `09fbad5`
(+ `09c6cd7`) · #97 `a70be0d`.
