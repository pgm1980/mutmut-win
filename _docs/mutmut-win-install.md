...
```bash
uv add "mutmut-win @ git+https://github.com/pgm1980/mutmut-win.git@v2.0.4" --dev
```
...
```
Erwartete Ausgabe: `mutmut-win, version 2.0.4`
...
- **Wiederholte Läufe:** v2.0.4 aktualisiert geänderte Dateien automatisch (mtime-Vergleich). Bei Problemen: `uv run mutmut-win run --force` für einen sauberen Neulauf.
