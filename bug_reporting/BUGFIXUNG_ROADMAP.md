...
`9fe800a9849fe35cf87f57b2f098ee02a08cd76a` veröffentlicht. Der Release-Nachfolger
wurde aus `fix/v2.21.1-windows314` integriert; aktueller Stand ist `main`.

**Aktueller Stand:** Der geprüfte Candidate `e48fda5e7cf0f633f4180b72e891db502605fa30` / Tree `b5fce8e29500b33a677094aaa17b3674f1e86bd1` wurde
reviewed als Zwei-Eltern-Merge `e91d338f9457b9d6526463fb0f835fab5d82736e` mit identischem Tree integriert.
Die vollständigen Candidate- und integrierten Gates einschließlich Suite, Security,
Hygiene und Dogfood sowie Doppelbuild und getrennte Installed-Smokes sind abgeschlossen.
Das annotierte Tag `v2.21.1` (Objekt `f2654e86250cf2a9636c09c17b4621e173cc2c2a`) zeigt auf
den Integrationsmerge. Der [GitHub-Release](https://github.com/pgm1980/mutmut-win/releases/tag/v2.21.1) wurde
zurückgelesen; die fünf publizierten Assets stimmen mit den geprüften lokalen
Artefakten überein und der Download-/Installationssmoke ist abgeschlossen.
27 MW221-Zielsystemfixes und alle 71 CX221-Befunde (2 P0, 64 P1, 5 P2) sind
`VERIFIED_FIXED`; MW221-003 ist `CLOSED_PROCESS`. Für diesen reinen Dokumentationsstand
gilt die direkte Ein-Eltern-Nachfolge des Integrationsmerges; das Tag bleibt
unverändert auf dem Integrationsmerge. Die Governance-/Supply-Chain-Prüfung des
Housekeeping-Commits und die abschließende Remoteprüfung werden extern an der
nach dem Commit bekannten Identität belegt; diese Dokumentbytes liefern keinen
Selbstnachweis.
...
4 OUT_OF_TARGET, 4 MIXED und 1 CLOSED_PROCESS.
Die 71 getrennt geführten Codex-Follow-up-Findings umfassen 2 P0, 64 P1 und 5 P2.
...
|---|---|---|---|
| MW221-004 | Pfadalias und Redirect über Komponenten-/Objektidentität unterscheiden, in Atomic Writer, DB, Staging, pytest-Boundary und Run-Lock konsistent | implementiert; Implementierungs-, Candidate- und Integrationsgates verifiziert | deterministische Alias-Seam-Tests plus reale 8.3-Probe, sofern das Volume einen Alias bereitstellt |
| MW221-005 | Apply/Show aus öffentlicher Originaldefinition erzeugen; Signatur, Defaults, Annotationen, Dekoratoren und Quellkontext erhalten | implementiert; Implementierungs-, Candidate- und Integrationsgates verifiziert | Roundtrip-Test führt die angewandte Mutation mit identischer Aufrufsignatur aus; erzeugter Patch ist anwendbar |
| MW221-006/-007 | Tokenizerfehler kontrolliert behandeln; abgeleitetes `mutants/` nicht rekursiv in seinen eigenen Stats-Digest aufnehmen | implementiert; Implementierungs-, Candidate- und Integrationsgates verifiziert | Tab-/Indent-Repros und vollständiger Run ohne Post-Stats-Selbstdrift |
| MW221-008 | Nichtautoritäre Mappingdaten nur zur Reihenfolge unabhängiger Mutanten-Tasks verwenden; innerhalb jedes Tasks native pytest-Reihenfolge, vollständige Suite und Vollsuite-Fingerprint bewahren, beim ersten echten Fehler abbrechen | sichere Teilkorrektur implementiert; selektive Autorität bleibt bewusst offen; Implementierungs-, Candidate- und Integrationsgates verifiziert | reihenfolgeabhängige Gegenprobe beweist unveränderte pytest-Reihenfolge; Survivor durchläuft alle Tests; Reuse bleibt an die Vollsuite gebunden |
| MW221-010/-011 | Full-/Subset-Autorität persistieren; Subset-Export sperren; Subset-Population in CLI `results` und Browser sichtbar als nicht release-ready kennzeichnen; Git-Dateinamen NUL-separiert lesen | implementiert; Implementierungs-, Candidate- und Integrationsgates verifiziert | Legacy-/Browser-/CLI-Subset exportiert nicht; Total/Score ist sichtbar auf den Subset-Scope begrenzt; non-ASCII-`--since-commit`-Repro vollständig |
| MW221-013 | Core-Drift terminal halten, reine Ambient-Drift diagnostisch abschließen und Basis-/Reuse-Autorität atomar entziehen | implementiert; Implementierungs-, Candidate- und Integrationsgates verifiziert | Source-/Test-/Config-/Projektimport-Drift bleibt `failed`; Ambient-Drift bleibt sichtbar, aber Score, Export und Reuse sind fail-closed; Widerrufsfehler bleibt recoveryfähig `running` |
| MW221-014/-017/-018 | stille Linkauslassung diagnostizieren; Fake-PID-Kills verhindern; E2E muss echten Survivor beweisen | implementiert; Implementierungs-, Candidate- und Integrationsgates verifiziert | fokussierte Safety-Tests und vollständige E2E-Referenz grün |
| MW221-019 / MW220-108/-115 | LIVE-State reparieren und Governance von Prosa-/Bool-Pins auf Zustandsinvarianten umstellen | implementiert; Implementierungs-, Candidate- und Integrationsgates verifiziert | Governance-Test bleibt sowohl bei ehrlichem In-Progress- als auch Abschlusszustand gültig und erkennt inkonsistente Übergänge |
...
| IDs | Maßnahme | Stand |
|---|---|---|
| MW221-020/-023/-024 | PEP-263-Roundtrip, vollständige Methodenargumente, parameterlose/`*args`-Methoden | implementiert; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| MW221-021/-026/-027/-028 | `typing_extensions.cast`, Regex-Klassen/Cache, strukturelle Docstrings und exakte Pragmas | implementiert; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| MW221-030/-031/-032 | Lock-Contention diagnostizieren, O(n)-Plan-Dublettenerkennung, Apply-Auflösung vor Invalidierung | implementiert; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| MW221-035/-036/-041/-042 | Dotenv-Basisbindung, Root-only-Workspace-Ausschlüsse, `#`-sichere Config und Node-ID-Normalisierung | implementiert; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| MW221-025/-037/-043 | kollisionssicherer Trampolin-Namensraum, vollständiger SQLite-Sidecar-Ausschluss und Exit-0-No-op für leere gültige `--since-commit`-Diffs | implementiert; Implementierungs-, Candidate- und Integrationsgates verifiziert |
...
Sie umfasst exakt CX221-001 bis CX221-071; ihre Prioritätsverteilung lautet
2 P0, 64 P1 und 5 P2.

| ID | Maßnahme | Stand |
|---|---|---|
| CX221-001 | Explizite `sys.path`-Unterbäume wie `project/build` separat hashen, wenn der Projektroot sie bei seinem Root-Inventar übersprungen hat | VERIFIED_FIXED; implementiert; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-002 | Versteckte Toolverzeichnisse in jeder Tiefe rekursiv ausschließen, generische fachliche Verzeichnisnamen aber nur am Workspace-Root | VERIFIED_FIXED; implementiert; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-003 | `tests_dir` und Git-Diffpfade unter Windows komponentenweise case-normalisieren | VERIFIED_FIXED; implementiert; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-004 | `show`/Browser wie `apply` an den persistierten `source_hash` binden und bei stale Staging fail-closed diagnostizieren | VERIFIED_FIXED; implementiert; Render- und CLI-Regression vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-005 | Lokale Identifier, die den reservierten Mutantentrenner erst an der ID-Grenze bilden, disjunkt und reversibel kodieren; Apply/Show auf die exakte Ursprungsdefinition binden | VERIFIED_FIXED; implementiert; E2E-Regression vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-006 | Reservierten Trennertext in Modul-/Paketkomponenten bewahren und nur den letzten lokalen numerischen Mutantensuffix parsen | VERIFIED_FIXED; implementiert; Mapping-/Parserregressionen vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-007 | Explizit konfigurierte externe Test-, Fixture- und Importbäume vollständig nach den tatsächlich gestagten Bytes hashen | VERIFIED_FIXED; implementiert; externe Generic-Child-Regression vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-008 | PEP-758-Mehrfach-Exceptions in allen Scan-Targets innerhalb des Parservertrags von Semgrep 1.175.0 halten, ohne Gate oder Allowlist abzuschwächen | VERIFIED_FIXED; implementiert; explizite Klammern plus AST-Guard; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-009 | Vollständige Staging-Ownership führen und gelöschte Source-/Fixture-/Rootdateien, Ghosts, Sidecars und read-only-Artefakte prunen; Read-only-Replacement und Modus-Restore an contained Non-Reparse-Identität und `st_nlink == 1` binden, externe Hardlinks fail-closed lassen | VERIFIED_FIXED; implementiert; Lösch-, Read-only-, Identity- und Hardlink-Regressionen vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-010 | Persistierten `generated_hash` als gemeinsame Provenienzgrenze für Show, Apply und Run erzwingen | VERIFIED_FIXED; implementiert; Missing-/Mismatch-/Edit-Regressionen vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-011 | Stabilen Digest über alle ausführbaren Staging- und Fixturebytes einfrieren und auf jedem autoritativen Erfolgspfad erneut validieren | VERIFIED_FIXED; implementiert; Phasen-/Driftregressionen vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-012 | Self-Dogfood-Governance nur in eindeutig erkennbarem generiertem Mutation-Staging überspringen; Git-lose normale Checkouts weiter prüfen | VERIFIED_FIXED; implementiert; Governance-Erkennung eng begrenzt; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-013 | Root-Ausschlüsse, explizite Importroots und bereits vorhandenes Staging so adjudizieren, dass keine unsichtbaren False-Green-Bytes verbleiben | VERIFIED_FIXED; implementiert; Root-/Namespace-Regressionen vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-014 | `.meta`-Eigentum nur über valides Schema und das gebundene Source-/Generated-Paar autorisieren; normale `.meta`-Fixtures erhalten | VERIFIED_FIXED; implementiert; Ownership-/Fixture-Regressionen vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-015 | Stateful pytest-/Tool-Caches isolieren und cachegesteuerte Testauswahl ohne gebundene Autorität ablehnen | VERIFIED_FIXED; implementiert; Cache-/pytest-Optionsregressionen vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-016 | `.py`-Endungen an CLI-Ingress, Source-Walk und Mutation-Ignore unter Windows case-insensitiv erkennen | VERIFIED_FIXED; implementiert; positiver Dry-run sowie realer 16-Mutanten-/Show-Gegenlauf; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-017 | Staging-Evidenz zusätzlich an leere Verzeichnistopologie, Dateiart, Modus und relevante Metadaten binden | VERIFIED_FIXED; implementiert; Datei-/Verzeichnismetadaten-Regressionen vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-018 | Sichtbare Root-/Fixturebytes vollständig binden und ausschließlich klaren Runtime-/PYC-Zustand vor dem Snapshot rekursiv entfernen | VERIFIED_FIXED; implementiert; Runtime-/PYC-Regressionen vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-019 | Vollständigen Staging-Snapshot vor der Coverage-Phase aufnehmen und direkt danach auf unveränderte Basis prüfen | VERIFIED_FIXED; implementiert; Pre-Coverage-Driftregression vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-020 | Reuse-Zuordnungen nach Fehler, Hard-Kill, Abbruch, Interrupt oder später Abschlussdrift revoke-first widerrufen; bei Widerrufsfehler den Run recoveryfähig `running` lassen | VERIFIED_FIXED; implementiert; SQLite-Trigger-/Recovery-Regression vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-021 | Pytest-Report-, Temp-, Coverage- und Benchmark-Ausgaben vor Pluginstart in einen frischen externen Runtime-Root umleiten | VERIFIED_FIXED; implementiert; echte JUnit-/Coverage-/Benchmark-Gegenproben grün; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-022 | `--min-score` für Namens-, Pfad- und `--since-commit`-Subsetläufe vor Ausführung ablehnen | VERIFIED_FIXED; implementiert; drei CLI-Regressionen vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-023 | Ausgeschlossenen Toolstate nicht indirekt über NTFS-Verzeichnisgröße/-Linkzahl in Cross-run-Digests wiedereinführen | VERIFIED_FIXED; implementiert; 0-zu-4096-NTFS- und Topologie-Regression vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-024 | Tool-eigene Atomic-Publish-Zeiten aus Cross-run-Reuse trennen, ohne die strikte In-run-Metadaten-/ABA-Evidenz zu lockern | VERIFIED_FIXED; implementiert; realer Meta-Lifecycle und Cache-Reuse gegengeprüft; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-025 | Kanonische DB-/Cache-Ausschlüsse durch sämtliche sekundären `sys.path`-, Editable- und Distribution-Walks propagieren | VERIFIED_FIXED; implementiert; ausgeschlossene DB-Bytes und benachbarte Runtimebytes dynamisch getrennt; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-026 | Gesamtbasis in fachlichen Core und Ambient-Anteil klassifizieren; nur Ambient-Drift diagnostisch bewahren und Autorität atomar entziehen | VERIFIED_FIXED; implementiert; Core-/Ambient-/Recovery-/Export-Regressionen vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-027 | Unsichere Intra-Suite-Umsortierung nichtautoritativer Hints verhindern; native pytest-Reihenfolge bewahren und nur Mutanten-Tasks planen | VERIFIED_FIXED; implementiert; reihenfolgeabhängige Real-Pytest-, Timeout- und Reuse-Regressionen vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-028 | Phasenausführungsbeweis nicht durch ausschließlich im Call-Body übersprungene Tests autorisieren | VERIFIED_FIXED; implementiert; reale All-skipped-Pytest-Regression vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-029 | DB-/Sidecar-Ausschlüsse auch in expliziten `also_copy`-/`extra_paths`-Mirrors durchsetzen und alte Stagingkopien prunen | VERIFIED_FIXED; implementiert; explizite Datei- und verschachtelte Verzeichnismirror-Regressionen vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-030 | Initial diagnostische Ambient-Basis bis in Stats- und Verdict-Reuse propagieren; beide Caches für diesen Lauf frisch beziehungsweise deaktiviert halten und bei Abschluss auch für eine unverändert unvollständige Basis alle aktuellen/historischen Fingerprints atomar deautorisieren | VERIFIED_FIXED; implementiert; frische Stats-, End-to-End-No-Reuse- und Future-Reuse-Regressionen vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-031 | Aktiven Release-Ref ohne Prosaselbstzertifikat auf Paketversion oder unmittelbaren Patchvorgänger begrenzen und README-/CLAUDE-Befehle an den kanonischen Guide binden | VERIFIED_FIXED; implementiert; exakte Guide-/README-/CLAUDE-Parser sowie Alt-/Zukunfts-/Serien-Gegenproben vorhanden; Remoteexistenz bleibt Live-Gate; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-032 | Nichtautoritative Vollsuite-Targets wie autoritative Auswahl über eine private geordnete Runtime-Argfile transportieren, damit Windows' Prozesskommandozeilenlimit die vollständige Suite nicht neutralisiert | VERIFIED_FIXED; implementiert; synthetische Zielmenge über 32.767 Zeichen beweist vollständigen Inhalt, native Reihenfolge und kurze `argv`; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-033 | Sicherheitstest-Setups an verschärfte reale Vorbedingungen binden: Phase-Guard-Double mit `skipped=False`, `--force`-Teillöschtest mit minimal gültigem Mutationsroot | VERIFIED_FIXED; implementiert; beide Orakel erreichen wieder ihre behauptete Atomic-/Löschgrenze; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-034 | uv-Hardlink-Linkzahlen aus langlebigen Project-/Dependency-/`sys.path`-Digests und deren Reopen-Identitätsvergleich entfernen, ohne die strikte In-run-Staging-Hardlink-Evidenz zu lockern | VERIFIED_FIXED; implementiert; Alias-add/remove-, Write-through-, Export-Doppelsnapshot- und Strict-Staging-Regressionen vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-035 | Flakiges NTFS-ABA-Testorakel auf beobachtbare leere Topologie, explizite Parent-Metadatenänderung und Dateimodus trennen | VERIFIED_FIXED; implementiert; 4/10-Flakeursache entfernt, Produktdigest unverändert; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-036 | Semgrep-Allowlist-Filehash nur für CRLF/bare-CR normalisieren und Unicode-Zeilentrenner bytewirksam binden | VERIFIED_FIXED; implementiert; U+2028-Bypassregression vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-037 | Windows-Layoutroot und finalen `__init__`-Stem bei der qualifizierten Mutantenidentität case-insensitiv mit der Runtime abgleichen | VERIFIED_FIXED; implementiert; realer `SRC/pkg/__INIT__.PY`-Subprozess beweist Tokenaktivierung; weitergehende Package-/Modul-Casefold-Challenge dynamisch verworfen; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-038 | Sämtliche geplanten automatischen und konfigurierten Staginginputs gegen tool-eigene Sidecar-, Guard-, Fingerprint- und Exportziele prüfen; Modul-/Package-/Resource-Namespace-/`.pyd`-Shadowing unter `src`/`source` vor jeder Mutation fail-closed abweisen | VERIFIED_FIXED; implementiert; auch data-only Namespaces werden abgewiesen, lose Bytecodeinputs vor Ausführung gepurgt; CLI-Text/JSON, `--force`-Nichtlöschung, Direct API, Dry-run, Copy-, Case-, Package-, Native- und Präzisionsregressionen vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-039 | Docstring-Erkennung auf konstanten `str`-Wert und erste Statementposition begrenzen, führende Bytes-/f-String-Verkettungen wieder mutieren, Semikolon-Docstrings erhalten und Wrapper-Doppelausführung verhindern | VERIFIED_FIXED; implementiert; Mutationsregressionen plus generierte Laufzeitproben mit korrektem `__doc__` und exakt einem Seiteneffekt grün; Implementierungs-, Candidate- und Integrationsgates verifiziert |
...
| CX221-046 | Dry-run bei PEP-263-Dekodierung und physischer Source-Identity-Deduplizierung an die reale Generation angleichen | VERIFIED_FIXED; implementiert; CP1252-, Overlap- und Windows-Alias-Regressionen ohne Workspacewrite vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
...
| CX221-048 | Leere automatische/konfigurierte Live-Namespaces materialisieren und entfallene leere Staging-Shells bottom-up entfernen, ohne explizite Mirrorroots zu löschen | VERIFIED_FIXED; implementiert; Zwei-Run- und reale `find_spec`-/PEP-420-Regressionen vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-049 | PEP-263-Cookie beim UTF-8-Fallback nur über physische LF-Zeilen bestimmen, damit Unicode-Zeilentrenner die echte zweite Cookiezeile nicht verdecken | VERIFIED_FIXED; implementiert; Latin-1/NEL-Regressionsbytes kompilieren mit aktualisiertem UTF-8-Cookie; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-050 | Aktive Architektur-, Design-, Lizenz- und Testsuppressionsverträge auf Windows plus exakt CPython 3.14.7, PEP-263-Quelltext und UTF-8-Metadaten sowie GitHub Release als Publikationskanal vereinheitlichen | VERIFIED_FIXED; implementiert; aktive Vertragsquellen und Kommentare korrigiert; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-051 | Native Releaseasset-Provenienz auf die drei Manifesttools begrenzen und Zizmor getrennt als PyPI-/`uv.lock`-Abhängigkeit mit Sdist- und Plattform-Wheel-Hashes ausweisen | VERIFIED_FIXED; implementiert; Phantom-ZIP/-API-Claim entfernt; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-052 | Exakten Sprint-39-Backlog anlegen und aktive Product-/Serena-/Sprint-Metadaten samt Governanceprüfung auf Scope, Branch, Reviewquellen, `NOT_EXECUTED` und Releasefolge synchronisieren | VERIFIED_FIXED; implementiert; Existenz und Pflichtinhalt maschinenlesbar gebunden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-053 | Lokalen Releasewrapper um gelocktes Zizmor 1.30.0 mit Offline-`regular`-/`pedantic`-Personas erweitern, damit billing-blockierte CI keine Security-Lücke erzeugt | VERIFIED_FIXED; implementiert; Pfad/Version/Personas/minimale Umgebung und Orchestrierung regressionsgebunden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-054 | Report-Provenienz als exakt markierte Artefakt-zu-Digest-Abbildung statt freie Hashteilstrings binden | VERIFIED_FIXED; implementiert; sechs eindeutige Zeilen werden direkt gegen Native-Manifest und `uv.lock` geprüft; Implementierungs-, Candidate- und Integrationsgates verifiziert |
...
| CX221-056 | Gesamten CPython-Derivatabschnitt einschließlich Herkunft, Anpassungsbeschreibung, Copyright und Anwendbarkeit zusätzlich zum PSF-Text exakt hashen | VERIFIED_FIXED; implementiert; positionsgebundener Abschnittshash vorhanden; Implementierungs-, Candidate- und Integrationsgates verifiziert |
| CX221-057 | Gemessenes Coverage-Laufzeitrisiko des 60-Minuten-Testjobs durch ein gepinntes 120-Minuten-Limit mit belastbarer Setup-/Runnerreserve schließen | VERIFIED_FIXED; implementiert; Messung 2.274/43, 85 %, 51:37 und Workflowregression dokumentiert; Implementierungs-, Candidate- und Integrationsgates verifiziert |
...
Lauf auf dem früheren Implementierungscommit `6e12964` bleibt historische
Evidenz; die aktuellen Nachweise werden in Abschnitt 13.4 commit-genau zugeordnet.
...
der nachfolgende Commit benötigte seine vollständige Revalidierung; der historische Nachweis auf `6e12964` ist in der Analyse, Abschnitt 7, erhalten.
...
Housekeeping erhalten. Bei dieser Dokumentkorrektur blieben Produktcode, Tests und
Befund-ID-Mengen unverändert. Der nachfolgende Candidate-Lauf auf `0fd46c7`
endete jedoch mit 1 failed/2.433 passed/43 skipped in 1.757,69 s und bestätigte
CX221-071: kurzzeitiger WinError 5 am regulären Journal, genau ein aktiver Run.
Die normale Vierthread-Probe reproduzierte den falschen Fehlertyp in 1 von 40
Versuchen. Der frühere Implementierungslauf auf `6e12964` bestand vollständig
mit 2.434/43, 85 % und allen übrigen Gates; er bleibt historische Evidenz.
Die Freigabe dieses Candidates wurde zurückgenommen; der jeweilige aktuelle
Gate- und Freigabestand steht in Abschnitt 13.4.

CX221-071 erhielt 26 deterministische Regressionen. Die gültigen Rotnachweise
betrugen 8 failed/10 passed beziehungsweise 5 failed/3 passed; der abschließende
Verbund aus sechs Datenbank-Testdateien bestand mit 122 passed/2 skipped in
171,17 s. Zwei getrennte normale Vierthread-Gegenläufe von Agent und Root
bestanden jeweils 100/100 mit genau einem Gewinner und ausschließlich den drei
erwarteten RunStateError pro Versuch. Die Neuprüfung ist auf Windows-Sidecars,
WinError 5 beziehungsweise null Dateilinks und höchstens drei vollständige
Prüfversuche begrenzt. Dauerhafte Unprüfbarkeit, Datenbank-/Elternpfade und echte
Hardlinks erhalten keine Freigabe. Ruff, Format und unabhängiger enger Review
bestanden; die jeweils aktuelle commit-genaue Vollqualifikation wird
getrennt in Abschnitt 13.4 belegt.

### 13.4 Aktueller Abschlussstand und exakte Sequenz

Der geprüfte Candidate `e48fda5e7cf0f633f4180b72e891db502605fa30` / Tree `b5fce8e29500b33a677094aaa17b3674f1e86bd1` wurde
reviewed als Zwei-Eltern-Merge `e91d338f9457b9d6526463fb0f835fab5d82736e` mit identischem Tree integriert.
Die vollständigen Candidate- und integrierten Gates einschließlich Suite, Security,
Hygiene und Dogfood sowie Doppelbuild und getrennte Installed-Smokes sind abgeschlossen.
Das annotierte Tag `v2.21.1` (Objekt `f2654e86250cf2a9636c09c17b4621e173cc2c2a`) zeigt auf
...
Die neun Sprint-39-Gates sind auf Basis der unten gebundenen tatsächlichen
Publikationsbelege geschlossen. Der Housekeeping-Commit darf ausschließlich die
sieben vorgesehenen Dokumente ändern und muss genau einen Parent M besitzen.
Tag und veröffentlichte Artefakte bleiben an M gebunden. Die Governance-/Supply-Chain-Prüfung
des Housekeeping-Commits und die abschließende Remoteprüfung werden extern an der
nach dem Commit bekannten Identität belegt; diese Dokumentbytes liefern keinen Selbstnachweis.

| Beleg | Commit / Tree | Tatsächliches Ergebnis |
|---|---|---|
| candidate | `e48fda5e7cf0f633f4180b72e891db502605fa30` / `b5fce8e29500b33a677094aaa17b3674f1e86bd1` | Windows CPython 3.14.7; 20 completed phase gates; suite 2460 passed/43 explained skips/1746.69 s; coverage 9760 statements/1441 missing/85 percent. Quality, dependencies, pytest floor, Semgrep and Native passed. Dogfood 91/91 authorized, 90 killed/1 Windows-equivalent survivor, no problem buckets. Hygiene clean, zero processes; CI NOT_EXECUTED. |
| integrated | `e91d338f9457b9d6526463fb0f835fab5d82736e` / `b5fce8e29500b33a677094aaa17b3674f1e86bd1` | Windows CPython 3.14.7; 20 completed phase gates; suite 2460 passed/43 explained skips/1757.32 s; coverage 9760 statements/1438 missing/85 percent. Quality, dependencies, pytest floor, Semgrep and Native passed. Dogfood 91/91 authorized, 90 killed/1 Windows-equivalent survivor, no problem buckets. Hygiene clean, zero processes; CI NOT_EXECUTED. |
| artifacts | `e91d338f9457b9d6526463fb0f835fab5d82736e` / `b5fce8e29500b33a677094aaa17b3674f1e86bd1` | Two reproducible builds, RECORD/inventories/provenance/epoch verified; Twine strict and wheel contents passed. SDIST-INVENTORY.txt SHA256 cc183e9164a2efe5d5278af9d8f16f0d49f2a4e48a58f5993370686a9baf266e; SHA256SUMS SHA256 fadd3a6b6a50d2be201e731f120497cff3fb898a0215514b50b44350513a8ad7; WHEEL-INVENTORY.txt SHA256 a51786693a85397b752fe15f739c11cea24b92dc802fd4d37152ca2e7d58562f; mutmut_win-2.21.1-py3-none-any.whl SHA256 313e3db909c17b28f07113d5f65bdd739aecde75ebf1368e0ed396e289a819a3; mutmut_win-2.21.1.tar.gz SHA256 b6b15b82207b2c5649a66ec7bb1899fff339b470563121e03e27ef606d229de6. Initial external verifier refusals were resolved by preserving two uv-generated one-byte .gitignore files separately and comparing UTF-8 README payload bytes directly. Unchanged archives subsequently passed the complete verifier, Twine strict and wheel contents. Both failures, original verifier and six README regression checks remain preserved. |
| installed | `e91d338f9457b9d6526463fb0f835fab5d82736e` / `b5fce8e29500b33a677094aaa17b3674f1e86bd1` | Fresh local archive installs: wheel 5/5 killed, sdist 5/5 killed; downloaded archive installs: wheel 5/5 killed, sdist 5/5 killed. Windows CPython 3.14.7, package 2.21.1, origin/CLI/dependencies/baselines passed; complete consumer mutation basis, no problem buckets. |
| publication | `e91d338f9457b9d6526463fb0f835fab5d82736e` / `b5fce8e29500b33a677094aaa17b3674f1e86bd1` | Published release 384431725 at https://github.com/pgm1980/mutmut-win/releases/tag/v2.21.1; annotated tag object f2654e86250cf2a9636c09c17b4621e173cc2c2a targets exact M. All five assets downloaded and byte/size/hash matched; ref and metadata readbacks stable, old tag unchanged. Both downloaded installs passed separately. Initial external readback setup failures were resolved; failure records remain preserved. Complete open-issues snapshot [] observed at 2026-09-08T03:47:47.386459+00:00; CI NOT_EXECUTED. |

Externe Rohbelege (SHA-256; die Zusammenfassungen stammen aus diesen abgeschlossenen Läufen):

- `C:\Users\pmitt\AppData\Local\Temp\mutmut-win-v2211-release-20260907\housekeeping-full-input-e91d338.json` — `22e9359885f4c81b839ec820e676f7eaa072130597f0b8374e5fb6be6a6d5123`
- `C:\Users\pmitt\AppData\Local\Temp\mutmut-win-v2211-release-20260907\candidate-complete-e48fda5.json` — `aae7386f10cc9c0968915ee5fa975b34b120c3d42ed2e8ab03b2d7524826c92a`
- `C:\Users\pmitt\AppData\Local\Temp\mutmut-win-v2211-release-20260907\integrated-complete-e91d338.json` — `f32cd18e20150713a6a315722ec4512553dea7622a18dffdc2551bdb8e20dc84`
- `C:\Users\pmitt\AppData\Local\Temp\mutmut-win-v2211-release-20260907\double-build-e91d338\completion.json` — `d0d6c4f96717c88780090fb1e2b6e1e97de37545094f602ea73ff7d73ea328a2`
- `C:\Users\pmitt\AppData\Local\Temp\mutmut-win-v2211-release-20260907\double-build-e91d338\build-harness-adjudication.json` — `a828f72a175af037e85153b7d61d8f95b7f1e9d70fcb4f95abb302c61df87b0a`
- `C:\Users\pmitt\AppData\Local\Temp\mutmut-win-v2211-release-20260907\installed-e91d338\completion.json` — `ee3b34fb83845f8c19a55ce2932aa27a103a7e5df875568db1b085a26735de0c`
- `C:\Users\pmitt\AppData\Local\Temp\mutmut-win-v2211-release-20260907\downloaded-installed-e91d338\completion.json` — `cf37db8e026060e0c6975d8433c2dd24ca2a472b96beb8314d7da0a4fb3ef2dc`
- `C:\Users\pmitt\AppData\Local\Temp\mutmut-win-v2211-release-20260907\installed-hygiene-e91d338.json` — `2e2f72118d2fef80cef32727a5a140b36ab2b2e366170b3e68ac4b5153d7d16b`
- `C:\Users\pmitt\AppData\Local\Temp\mutmut-win-v2211-release-20260907\downloaded-installed-hygiene-e91d338.json` — `13afa92a072e359b7d2caaf9d977d40a9f7323ce6a2686d459a6ac2833269e19`
- `C:\Users\pmitt\AppData\Local\Temp\mutmut-win-v2211-release-20260907\publication-e91d338-verified\readback.json` — `736a932daa3147b4b5082da5ac08f4cd0c30112c6c3a33f6fb399d709e706ecd`
- `C:\Users\pmitt\AppData\Local\Temp\mutmut-win-v2211-release-20260907\publication-e91d338-verified\EVIDENCE-SHA256.json` — `a2f29048251a7b361e9946ba03c58617781b78da89d9e98c8d426df3b3c6b82d`
- `C:\Users\pmitt\AppData\Local\Temp\mutmut-win-v2211-release-20260907\open-issues-observation.json` — `395c88fe245de3d3e81624bbf659bc69e5307f94714292002d80436a280a3c60`
