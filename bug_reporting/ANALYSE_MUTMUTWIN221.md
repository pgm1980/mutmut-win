...
**Status:** v2.21.1 ist ein unveröffentlichter Kandidat. Implementierte Fixes
besitzen fokussierte Evidenz, aber noch kein vollständiges Finalgate und keine
Artefaktautorität.
...
veröffentlichten Release. `IMPLEMENTED_PENDING_FINAL` bedeutet, dass Code und
gezielte Regression vorliegen, das quieszente Gesamtgate aber noch fehlt.
...
Prioritätsverteilung lautet 2 P0, 55 P1 und 5 P2; alle 62 stehen auf
...
| v2.21.1 vollständige Coverage-Arbeitsbaumsuite | dieselben 2.303 passed/43 skipped/0 failed; 9.727 Statements, 1.456 Missing, 85 %, 35:15 min | vollständige lokale Implementierungsevidenz oberhalb der 80-Prozent-Schwelle |
