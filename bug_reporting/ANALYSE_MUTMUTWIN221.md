...
**Status:** v2.21.1 ist ein lokal validierter, unveröffentlichter Kandidat. Die
Fixes besitzen vollständige Windows-/CPython-3.14.7-Kandidatenevidenz, aber noch
keine Integrations-, Artefakt-, Tag- oder Releaseautorität.
...
| Befund | Urteil für Windows/3.14.7 | Stand im v2.21.1-Kandidaten |
|---|---|---|
...
| MW221-019 | P1 | VERIFIED_FIXED | Governance prüft Struktur und Zustandsübergänge statt feste Bool-Werte, Branches, Commits oder Erfolgsprosa; LIVE-State ist auf v2.21.1 in Arbeit gestellt. |
...
Das getrennte Codex-Register umfasst damit exakt CX221-001 bis CX221-062. Die
Prioritätsverteilung lautet 2 P0, 55 P1 und 5 P2; alle 62 stehen nach dem
lokalen Kandidatengesamtgate auf `VERIFIED_FIXED`.
...
Buildhost-Provenienz und keine Linux-Runtime-Zusage. Diese Kandidatenevidenz
ersetzt nicht die finale Wiederholung nach dem letzten Diff-Freeze.
...
| v2.21.1 commit-genaue Coverage-Kandidatensuite | Commit `4daed987742d24b420285fec46fc91bc2e1189a4`: 2.303 passed/43 skipped/0 failed; 9.727 Statements, 1.450 Missing, 85 %, 43:51 min | vollständige lokale Kandidatenevidenz oberhalb der 80-Prozent-Schwelle |
...
| v2.21.1 Native-Release-Gate | sauberer Commit `4daed987742d24b420285fec46fc91bc2e1189a4` in frisch gelockter CPython-3.14.7-Releaseumgebung: actionlint, ShellCheck, Pyflakes, Zizmor regular/pedantic und Gitleaks Worktree/History bestanden | commit-gebundene lokale Kandidatenevidenz; auf integriertem Commit zu wiederholen |
...
v2.21.1 bleibt **NO-GO**. Der aktuelle Windows-/CPython-3.14.7-Arbeitsbaum hat
die vollständige strikte Suite, Coverage, Ruff/Format, mypy, Import-Linter,
Lock/Audit, das kanonische Semgrep-Gate und den Dogfood-Piloten bestanden. Noch
offen sind der saubere Kandidatencommit samt kanonischem Native-Release-Gate,
